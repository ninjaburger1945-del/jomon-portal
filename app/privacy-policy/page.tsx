    ...
    <div className={styles.page}>
      ...
      <main className={styles.main}>
        <article className={styles.article}>
          ...
          <section className={styles.section}>
            <h2 className={styles.sectionTitle}>6. 欧州ユーザーの権利について（GDPR対応）</h2>
            <p>当サイトをご利用いただくEEA（欧州経済領域）、英国、またはスイスにお住まいの方は、GDPR（一般データ保護規則）およびその他の適用法令に基づく個人データに関する権利を有しています。これらの権利には、あなたのデータへのアクセス、訂正、削除、処理の制限、ポータビリティ、および異議申し立てが含まれます。</p>
            <p>当サイトにおいて、Google広告パートナーはあなたの個人データを処理する際、あなたの同意管理プラットフォーム（CMP）を通じた明示的な同意に依拠しています。これらの権利を行使したい場合、またはGoogleおよび広告パートナーによるあなたの個人データの処理に関して質問がある場合は、お問い合わせフォームからご連絡ください。その際は、「GDPR関連のお問い合わせ」である旨をお知らせください。当サイト運営事務局では、適用法令の範囲内でお応えします。</p>
          </section>

          <section className={styles.section}>
            <h2 className={styles.sectionTitle}>7. 本ポリシーの変更</h2>
